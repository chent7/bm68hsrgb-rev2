...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT_65_ansi(
        ...
        KC_LCTL, KC_LGUI, KC_LALT,                            KC_SPC,                    MO(1),   KC_VOLD, KC_VOLU, KC_LEFT, KC_DOWN, KC_RGHT
    ),
    [1] = LAYOUT_65_ansi(
        ...
        _______, _______, _______,                            RGB_TOG,                   _______, _______, _______, _______, RGB_VAD, _______
    ),
    [2] = LAYOUT_65_ansi(
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
